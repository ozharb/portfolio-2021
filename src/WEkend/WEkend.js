...
function WEkend() {
  ...
  let screenshots = [
    [
      wekendSS1,
      "Users events are organized by day easily accessed on their day-board",
    ],
    [wekendSS2, "Users can see all events they and their friends have posted"],
    [
      wekendSS3,
      "User can see all their friends along with their friendship status",
    ],
  ];
        ...
        <section className="projects-left">
          <section className="app-main app-info">
              ...
              <div className="app-left-right">
                <article className="app-one app-links-container">
                  ...
                  <div className="logo-links categories">
                    ...
                    <div className="logo-link categories">
                      <i className="fas calendar-alt">
                        <FontAwesomeIcon
                          className="calendar-alt icon"
                          icon="calendar-alt"
                        />
                      </i>
                      <br />
                    ...
                    <div className="logo-link categories">
                      <i className="fas fa-users">
                        <FontAwesomeIcon className="user icon" icon="users" />
                      </i>
                      <br />
                ...
                <article className="app-one app-links-container">
                  ...
                  <div className="logo-links">
                    <div className="logo-link">
                      <a
                        href="https://github.com/ozharb/Wekend-client"
                        rel="noreferrer"
                        target="_blank"
                      >
                    ...
                    <div className="logo-link">
                      <a
                        href="https://wekend-client-ozharb.vercel.app/"
                        rel="noreferrer"
                        target="_blank"
                      >
                        <img
            ...
            <article className="app-one">
              <h2>Description</h2>
              <p>
                A social event planning app where users can post events for
                friends to see as well as see and rsvp to events their friends
                have posted.
              </p>
            </article>
            <article className="app-one">
              <h2> Inspiration</h2>
              <p>
                I miss my friends. I think we all do. The pandemic kept us away
                from friends and reminded us that weekends aren't the same
                without them.
              </p>
              <p>
                I wanted to create an app that makes planning weekends with
                friends easy to help us make the most of the little time we get
                to spend with them.
              </p>
              <p>
                Instead of having to ask what each person is up to, what if you
                just knew? That's the question that got me building this
                project.
              </p>
            </article>
            <article className="app-one">
