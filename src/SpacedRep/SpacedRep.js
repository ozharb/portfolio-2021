...
function SpacedRep() {
  ...
  let screenshots = [
    [spacedRepLogin, "secure login via JWT"],
    [spacedRepStart, "Users see all the words to practice"],
    [
      spacedRepTranslate,
      "Words to practice are ordered by the spaced-repetition learning technique",
    ],
        ...
        <section className="projects-left">
          <section className="app-main app-info">
              ...
              <div className="app-left-right">
                <article className="app-one app-links-container">
                  ...
                  <div className="logo-links">
                    ...
                    <div className="logo-link">
                      <i className="fas brain">
                        <FontAwesomeIcon className="brain icon" icon="brain" />
                      </i>
                      <br />
                ...
                <article className="app-one app-links-container">
                  ...
                  <div className="logo-links">
                    <div className="logo-link">
                      <a
                        href="https://github.com/ozharb/spaced-repetition"
                        rel="noreferrer"
                        target="_blank"
                      >
                    ...
                    <div className="logo-link">
                      <a
                        href="https://spaced-repetition-ozharb.vercel.app/"
                        rel="noreferrer"
                        target="_blank"
                      >
                        <img
            ...
            <article className="app-one">
              <h2>Description</h2>
              <p>
                A language learning app for practicing translations for a given
                set of words.
              </p>
            </article>
            <article className="app-one">
              ...
              <p>
                This project was started with an existing codebase for the front
                and backend along with tests not yet passing.
              </p>
              <p>
                The spaced-repetition learning technique is implemented using an
                algorithm and a linked list data structure.
              </p>
              <p>
                The algorithm orders words with more incorrect guesses ahead of
                words with fewer incorrect answers. This forces the user to
                practice words they are struggling with more often than other
                words.
              </p>
              <p>
                In addition to using an algorithm to implement the learning
                technique, the app also uses a linked list to store and order
                the data.
              </p>
              <p>
                Correct guesses force words to get pushed back in the linked
                list further than words with incorrect guesses.
              </p>
              <p>
                I enjoyed working with a linked list for this project which I
                found to be perfect for this type of data.
              </p>
            </article>
            <article className="app-one">
              <h2>Tech</h2>
